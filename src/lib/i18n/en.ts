...
export const en = {
  ...
  homeStep1Plain: "Describe what happened in plain words. No legal language needed.",
  homeStep2Title: "Analysis",
  homeStep2Plain: "Understand what may be happening, your rights, and the law that may apply.",
  ...
  printHint: "Download PDF opens your browser's print dialog — choose 'Save as PDF'.",
