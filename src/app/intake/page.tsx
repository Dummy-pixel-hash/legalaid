    ...
    <div className="mx-auto max-w-3xl px-4 py-10 sm:px-6 sm:py-14">
      ...
      {params.get("demo") && (
        <p className="mt-4 flex items-center gap-2 rounded-md border border-line bg-surface-muted px-3 py-2 text-xs text-ink-70">
          <Info className="h-3.5 w-3.5 shrink-0 text-accent-strong" aria-hidden />
          {t("scenarioPrefilled")}
        </p>
      )}
                ...
                <div className="sm:col-span-2">
                  ...
                  >
                    ...
                    <SelectContent>
                      ...
                      <SelectItem value="consumer">{t("domainConsumerOption")}</SelectItem>
                      <SelectItem value="labour">{t("domainLabourOption")}</SelectItem>
                      <SelectItem value="tenant">{t("domainTenantOption")}</SelectItem>
                    </SelectContent>
                  </Select>
                </div>
                <div>
