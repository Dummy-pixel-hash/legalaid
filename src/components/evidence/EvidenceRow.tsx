		...
		>
			...
			{item.status !== "unset" && (
				<input
					...
					className="mt-3 min-h-11 w-full rounded-md border border-line bg-background px-3 py-2 text-xs text-ink placeholder:text-ink-50 focus:border-accent-strong focus:outline-none focus:ring-2 focus:ring-accent-strong/20"
				/>
			)}
		</li>
	);
